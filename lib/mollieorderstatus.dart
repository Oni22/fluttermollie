                          ...
                          Expanded(
                            ...
                            child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                     Container(
                                    child: Text(o.products[0].name + "..." , style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),overflow: TextOverflow.ellipsis,),
                                    ),
                                    Container(
                                      child: Text("Status: " + o.status, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),
                                        overflow: TextOverflow.ellipsis,),
                                    ),
                                    Container(
                                      child: Text("Ordernr.: " + o.orderNumber, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                                    ),
                                    Container(
                                      child: Text("Ordered: " + formattedDate,
